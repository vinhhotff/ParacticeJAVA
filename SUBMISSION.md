...
3.  **Truy cập ứng dụng**:
    ...
    *   Tài liệu API Swagger (Swagger UI): [http://localhost:8080/swagger-ui.html](http://localhost:8080/swagger-ui.html)
4.  **Thử nghiệm API qua Postman**:
    *   File Postman Collection cấu hình sẵn: [postman/ResourceAllocation.postman_collection.json](postman/ResourceAllocation.postman_collection.json)
    *   Mentor chỉ cần import file JSON này vào Postman để thử nghiệm đầy đủ toàn bộ API (CRUD, báo cáo, và các tính năng AI).
